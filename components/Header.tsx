  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white border-b border-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between gap-8">
        ...
        {/* Ícones de Ação (Favoritos e Carrinho) */}
        <div className="flex items-center space-x-6">
          ...
          >
            ...
            {cartCount > 0 && (
              <span className="absolute -top-1 -right-1 bg-[#D12F2F] text-white text-[9px] font-bold h-4 w-4 rounded-full flex items-center justify-center shadow-sm">
                {cartCount}
              </span>
            )}
          </button>
